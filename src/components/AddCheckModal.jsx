...
function AddCheckModal({ isOpen, onClose, insuredId, vehicleId, insuranceId, onCheckAdded }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="w-full max-w-[700px] bg-[rgb(255,255,255)] rounded-lg shadow-lg p-6 max-h-[590px] overflow-y-auto hide-scrollbar">
                ...
                <form onSubmit={handleSubmit} className="mt-2 space-y-4 rounded-md border dark:border-borderNav border dark:border-borderNav-gray-300 dark:border dark:border-borderNav-dark3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-2 border dark:border-borderNav rounded-md"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <div className="flex justify-end px-4 pb-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className={`px-4 py-2 w-full text-[rgb(255,255,255)] bg-indigo-600 rounded-md ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-indigo-500'}`}
                        >
