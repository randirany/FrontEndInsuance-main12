        ...
        <div className="w-full md:w-64 rounded-lg bg-white shadow-sm">
          <div className="p-6">
            ...
            <div className="space-y-4 grid grid-cols-1">
              <div><label className="text-sm text-gray-500">First Name</label><p className="text-gray-900">{customerData.first_name || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">Last Name</label><p className="text-gray-900">{customerData.last_name || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">Mobile</label><p className="text-gray-900">{customerData.phone_number || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">Identity</label><p className="text-gray-900">{customerData.id_Number || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">Birth Date</label><p className="text-gray-900">{customerData.birth_date || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">Join Date</label><p className="text-gray-900">{customerData.joining_date || "N/A"}</p></div>
              <div><label className="text-sm text-gray-500">City</label><p className="text-gray-900">{customerData.city || "N/A"}</p></div>
          ...
          <div className="mb-3 rounded-lg bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-md border-2 border-blue-500 px-4 py-2 text-sm text-blue-700"
              >
                Add Vehicle
              </button>
            </div>
              ...
              {vehicles.map((vehicle, index) => (
                <SwiperSlide key={index}>
                  <div className="max-w-full text-center">
                    ...
                    <button className="rounded-md border-2 border-gray-500 px-4 py-2 text-sm text-gray-900"
                      onClick={() => {
