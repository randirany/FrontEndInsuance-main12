...
export default function Customers() {
    ...
    return (
        ...
        >
            <div className="bg-[rgb(255,255,255)] dark:bg-navbarBack flex p-[22px] rounded-md justify-between items-center mb-3 " dir={language === "en" ? "ltr" : "rtl"}>
            ...
            <DataGrid
                ...
                sx={{
                    backgroundColor: (theme) => theme.palette.mode === 'dark' ? 'rgb(2, 13, 26)' : 'rgb(255,255,255)', 
                    color: (theme) => theme.palette.mode === 'dark' ? 'rgb(2, 13, 26)' : 'rgb(255,255,255)',       
                    border: 0,
                            ...
                            <form onSubmit={handleSubmit} className="mt-2 space-y-4 border dark:border-borderNav border dark:border-borderNav-gray-300 rounded-md">
                                <div className="grid grid-cols-2 gap-3 px-4 py-4">
                                    <div>
                                        ...
                                        <input type="text" name="first_name" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.first_name} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">Last Name</label>
                                        <input type="text" name="last_name" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.last_name} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">ID Number</label>
                                        <input type="text" name="id_Number" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.id_Number} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">Phone Number</label>
                                        <input type="text" name="phone_number" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.phone_number} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">Joining Date</label>
                                        <input type="date" name="joining_date" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.joining_date} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">Birth Date</label>
                                        <input type="date" name="birth_date" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.birth_date} onChange={handleInputChange} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium">City</label>
                                        <input type="text" name="city" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.city} onChange={handleInputChange} />
                                    </div>
                                    <div className="col-span-2">
                                        <label className="block text-sm font-medium">Notes</label>
                                        <textarea name="notes" rows="2" className="w-full p-2 border dark:border-borderNav rounded-md" value={formData.notes} onChange={handleInputChange} />
                                    </div>
                                </div>
