...
function HolyLandRep() {
    ...
    const fetchHoliReports = async () => {
        ...
        try {
            ...
            const res = await axios.get(`http://localhost:3002/api/v1/HolyLand/all`, { // استبدل بالمسار الصحيح
                headers: { token }
            });
        ...
        <div className="px-4 py-7  dark:bg-dark2 dark:text-dark3" style={{ minHeight: '100vh' }}>
            ...
            <div className="bg-[rgb(255,255,255)] dark:bg-navbarBack flex p-[22px] rounded-md justify-between items-center mb-3">
                <div className="flex gap-[14px]">
                    ...
                    <a className href="/insuranceCompany" data-discover="true">HolyLand Accident Reports</a>
                </div>
                <button
                    onClick={() => {
