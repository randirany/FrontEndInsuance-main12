...
function Navbar({ setSidebarOpen, sidebarOpen }) {
  ...
  return (
    <div className={` bg-[rgb(255,255,255)]  dark:bg-navbarBack dark:text-dark3  z-10 fixed top-0 ${language == "en" ? "right-0" : "left-0"} 2md:[width:calc(100%-259px)] w-full`}>
    <div className='navblayout'>
       <div className={`flex justify-between  py-2  items-center`} dir={language === "ar" ? "rtl" : "ltr"}>
        <div className='flex justify-between grow items-center'>
          ...
          <button
            className={` dark:bg-dark4 z-50 p-2 text-rgb(255,255,255) rounded shadow-md cursor-pointer 2md:hidden`} // Positioned, styled, and hidden on 2md+
            onClick={() => {
        ...
        <div className=''>
          <div className='flex  justify-center items-center gap-2'>
            <button className='flex items-centergap-3.5 rounded-full border dark:border-borderNav bg-[graySpan]  p-2 outline-none ring-primary transition-colors focus-visible:ring-1 dark:bg-black-300 min-[1015px]:w-[300px] min-[1015px]:px-5'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" className="max-[1015px]:size-5"><g clipPath="url(#clip0_1699_11536)"><path fillRule="evenodd" clipRule="evenodd" d="M8.625 2.0625C5.00063 2.0625 2.0625 5.00063 2.0625 8.625C2.0625 12.2494 5.00063 15.1875 8.625 15.1875C12.2494 15.1875 15.1875 12.2494 15.1875 8.625C15.1875 5.00063 12.2494 2.0625 8.625 2.0625ZM0.9375 8.625C0.9375 4.37931 4.37931 0.9375 8.625 0.9375C12.8707 0.9375 16.3125 4.37931 16.3125 8.625C16.3125 10.5454 15.6083 12.3013 14.4441 13.6487L16.8977 16.1023C17.1174 16.3219 17.1174 16.6781 16.8977 16.8977C16.6781 17.1174 16.3219 17.1174 16.1023 16.8977L13.6487 14.4441C12.3013 15.6083 10.5454 16.3125 8.625 16.3125C4.37931 16.3125 0.9375 12.8707 0.9375 8.625Z"></path></g><defs><clipPath id="clip0_1699_11536"><rect width="18" height="18" fill="[rgb(255,255,255)]"></rect></clipPath></defs></svg>
              <span className="max-[1015px]:sr-only mx-2 text-[graySpan]">{t("nav.Search")}</span>
            </button>
            <button onClick={handleThemeToggle} className="group rounded-full bg-gray-3 p-[5px] text-[#111928] outline-1 outline-primary focus-visible:outline bg-[#F3F4F6]  dark:bg-dark2">
              <span className="sr-only">Switch to dark mode</span>
              <span aria-hidden="true" className="relative flex gap-2.5">
<span
  className={`
    absolute size-[38px] rounded-full border dark:border-borderNav border dark:border-borderNav-gray-200 bg-[rgb(255,255,255)]
    transition-all duration-300 ease-in-out  // أضفت duration و easing لتحريك أنعم
    dark:border dark:border-borderNav-none dark:bg-dark-2 dark:group-hover:bg-dark-3
    ${isDarkMode && language === 'en' ? 'translate-x-[48px]' : ''}
    ${isDarkMode && language === 'ar' ? '-translate-x-[48px]' : ''}
    // في الوضع الفاتح، لا يوجد translate إضافي
  `}
></span>                <span className="relative grid size-[38px] place-items-center rounded-full"
                ><svg className='dark:text-dark3' width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M10 1.042c.345 0 .625.28.625.625V2.5a.625.625 0 11-1.25 0v-.833c0-.346.28-.625.625-.625zM3.666 3.665a.625.625 0 01.883 0l.328.328a.625.625 0 01-.884.884l-.327-.328a.625.625 0 010-.884zm12.668 0a.625.625 0 010 .884l-.327.328a.625.625 0 01-.884-.884l.327-.327a.625.625 0 01.884 0zM10 5.626a4.375 4.375 0 100 8.75 4.375 4.375 0 000-8.75zM4.375 10a5.625 5.625 0 1111.25 0 5.625 5.625 0 01-11.25 0zm-3.333 0c0-.345.28-.625.625-.625H2.5a.625.625 0 110 1.25h-.833A.625.625 0 011.042 10zm15.833 0c0-.345.28-.625.625-.625h.833a.625.625 0 010 1.25H17.5a.625.625 0 01-.625-.625zm-1.752 5.123a.625.625 0 01.884 0l.327.327a.625.625 0 11-.884.884l-.327-.327a.625.625 0 010-.884zm-10.246 0a.625.625 0 010 .884l-.328.327a.625.625 0 11-.883-.884l.327-.327a.625.625 0 01.884 0zM10 16.875c.345 0 .625.28.625.625v.833a.625.625 0 01-1.25 0V17.5c0-.345.28-.625.625-.625z"></path></svg></span><span className="relative grid size-[38px] place-items-center rounded-full dark:text-[rgb(255,255,255)] dark:bg-dark3"><svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M9.18 2.334a7.71 7.71 0 108.485 8.485A6.042 6.042 0 119.18 2.335zM1.042 10a8.958 8.958 0 018.958-8.958c.598 0 .896.476.948.855.049.364-.086.828-.505 1.082a4.792 4.792 0 106.579 6.579c.253-.42.717-.555 1.081-.506.38.052.856.35.856.948A8.958 8.958 0 011.04 10z"></path></svg></span></span></button>


            {/* <div className="bg-red-500 dark:bg-blue-500 py-4 fixed top-0 left-0 right-0 z-10">
              Navbar Test
            </div> */}


            <div className="relative">
              <button className="grid dark:bg-dark4 dark:border dark:border-borderNav-[darkborder dark:border-borderNav] size-12 place-items-center rounded-full border dark:border-borderNav bg-gray-2 text-dark outline-none hover:text-primary focus-visible:border dark:border-borderNav-primary focus-visible:text-primary dark:border dark:border-borderNav-dark-4 dark:bg-dark-3 dark:text-[rgb(255,255,255)] dark:focus-visible:border dark:border-borderNav-primary" aria-expanded="false" aria-haspopup="menu" data-state="closed" onClick={toggleNotification}><span className="relative">
                ...
                <span className="absolute right-0 top-0 z-1 size-2 rounded-full bg-red-light ring-2 ring-gray-2 bg-[redPoint]">
                  <span className="absolute inset-0 -z-1 animate-ping rounded-full bg-red-light opacity-75 bg-[#F56060]">
                  </span>
                </span>
              </span>
              </button>
              {notificationOpen && (
                <div role="menu" aria-orientation="vertical" className={` dark:bg-nav z-10 pointer-events-auto absolute z-99 mt-2 min-w-[8rem] origin-top-right rounded-lg fade-in-0 zoom-in-95 left-[-20px] 2md:left-0 -translate-x-1/2 border dark:border-borderNav border dark:border-borderNav-stroke bg-[rgb(255,255,255)] px-3.5 py-3 shadow-md dark:border dark:border-borderNav-dark3 dark:bg-gray-dark min-[350px]:min-w-[17rem]   2md:w-[20rem]${notificationOpen ? "block" : "hidden"}`}>
                  <div className="mb-1 flex items-center justify-between px-2 py-1.5"><span className="text-lg font-medium dark:text-[rgb(255,255,255)]">{t("nav.dropdown.title")}</span>
                    <span className="rounded-md bg-primary px-[9px] py-0.5 text-xs font-medium text-[rgb(255,255,255)]">5 new</span></div>
                  <ul className='mb-3 max-h-[23rem] space-y-1.5 overflow-y-auto z-12'>
                    <li role="menuitem">
                      <a className="flex items-center gap-4 rounded-lg px-2 py-1.5 outline-none hover:bg-gray-2 focus-visible:bg-gray-2 dark:hover:bg-dark-3 dark:focus-visible:bg-dark-3" href="#">
                        <img alt="User" src={`${avater}`} loading="lazy" width="200" height="200" decoding="async" data-nimg="1" className="size-14 rounded-full object-cover" style={{ color: " transparent;" }} />

                        <div>
                          <strong className="block text-sm font-medium text-dark dark:text-[rgb(255,255,255)]">Piter Joined the Team!</strong><span className="truncate text-sm font-medium text-dark-5 dark:text-dark-6">Congratulate him</span>
                        </div>
                      </a>
                    </li>
                    <li role="menuitem">
                  ...
                  <a className="block rounded-lg border dark:border-borderNav border dark:border-borderNav-primary p-2 text-center text-sm font-medium tracking-wide text-primary outline-none transition-colors hover:bg-blue-light-5 focus:bg-blue-light-5 focus:text-primary focus-visible:border dark:border-borderNav-primary dark:border dark:border-borderNav-dark-3 dark:text-dark-6 dark:hover:border dark:border-borderNav-dark-5 dark:hover:bg-dark-3 dark:hover:text-dark-7 dark:focus-visible:border dark:border-borderNav-dark-5 dark:focus-visible:bg-dark-3 dark:focus-visible:text-dark-7" href="#">{t("nav.dropdown.showAll")}</a>
                </div>
              )
            ...
            <div className="relative">
              <button className="rounded align-middle outline-none ring-primary ring-offset-2 focus-visible:ring-1 dark:ring-offset-gray-dark" aria-expanded="false" aria-haspopup="menu" data-state="closed"><span className="sr-only">My Account</span>
                <figure className="flex items-center gap-3" onClick={toggleProfile}>
                  <img alt="Avatar" width="200" height="200" className="size-12" style={{ color: "transparent", borderRadius: '50%' }}
                    src={`${avater}`} />
                  <figcaption className="dark:text-textNav flex items-center gap-1 font-medium text-dark  max-[1024px]:sr-only">
                    <span className='dark:text-textNav '>John Smith</span>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="currentColor" aria-hidden="true" className={`dark:text-textNav ${profileOpen ? "transition-transform rotate-0" : "rotate-180 transition-transform"}`} strokeWidth="1.5"><path fillRule="evenodd" clipRule="evenodd" d="M10.551 7.728a.687.687 0 01.895 0l6.417 5.5a.687.687 0 11-.895 1.044l-5.97-5.117-5.969 5.117a.687.687 0 01-.894-1.044l6.416-5.5z"></path>
                    </svg>
                  </figcaption>
                </figure>
              </button>
              <div className={`dark:bg-nav  z-10 pointer-events-auto absolute z-99 mt-2 min-w-[8rem] origin-top-right rounded-lg fade-in-0 zoom-in-95 right-0 animate-in border dark:border-borderNav border dark:border-borderNav-stroke bg-[rgb(255,255,255)] shadow-md dark:border dark:border-borderNav-dark4 dark:bg-gray-dark min-[230px]:min-w-[17.5rem] ${profileOpen ? "block" : "hidden"}`}>
