  ...
  return (
    <>
      <div
        id="sidebar"
        className={`
          bg-white sidebar py-[20px] px-2 md:px-4 fixed top-0 bottom-0 z-40  w-xs
          transform transition-transform duration-300 ease-in-out ${isRTL ? 'right-0 border-l' : 'left-0 border-r'}
      ...
      >
        <div className='mb-4'>
          <img src={logo} alt={t('logoAlt', 'Company Logo')} />
        </div>
        ...
        <div className='mt-6 flex-1 pr-3 min-[850px]:mt-10 overflow-y-scroll h-[calc(100%-50px)] hide-scrollbar'>
          <div className="mb-4">
            ...
            <nav role="navigation" aria-label={t("sideBar.mainMenu.title")}>
              <ul className="space-y-2">
                <li>
                  <Link dir={language === "en" ? "ltr" : "rtl"} to='/home' className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3">
                ...
                <li>
                  <Link to='/customers' className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3">
                ...
                <li>
                  <div>
                    <Link aria-expanded="false"  to='/InsuranceCompany' className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white flex w-full items-center gap-3 py-3">
                ...
                {/* <li>
                  <div>
                    <button aria-expanded="false" className={`${isOpenReport ? 'bg-[rgba(87,80,241,0.07)] text-primary text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white flex w-full items-center gap-3 py-3' : "text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white flex w-full items-center gap-3 py-3"}`} onClick={() => setIsOpenReport((prev) => !prev)}>
                    ...
                    </button>
                    {
                      isOpenReport && (
                        <ul className="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                          <li role="none">
                            <button onClick={() => setIsOpenMandatory(true)} className="text-[14px] rounded-lg px-3.5 font-medium transition-all duration-200  hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2">
                              <span>{t("sideBar.mainMenu.categore.insucresComp.categore.Mandatory")}</span>
                            </button>
                          </li>
                          <li role="none">
                            <button onClick={() => setIsOpenThird(true)} className="text-[14px] rounded-lg px-3.5 font-medium transition-all duration-200  hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2">
                              <span>{t("sideBar.mainMenu.categore.insucresComp.categore.Third")}</span>
                            </button>
                          </li>
                          <li role="none">
                            <button onClick={() => setIsOpenFull(true)} className="text-[14px] rounded-lg px-3.5 font-medium transition-all duration-200  hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2">
                ...
                <li>
                  <Link to='/departments' className="text-[14px]  rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3">
                    <svg width={24} height={24} viewBox="0 0 24 24" className="size-6 shrink-0 w-[19px] h-[19px]" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M12.0001 1.25C9.37678 1.25 7.25013 3.37665 7.25013 6C7.25013 8.62335 9.37678 10.75 12.0001 10.75C14.6235 10.75 16.7501 8.62335 16.7501 6C16.7501 3.37665 14.6235 1.25 12.0001 1.25ZM8.75013 6C8.75013 4.20507 10.2052 2.75 12.0001 2.75C13.7951 2.75 15.2501 4.20507 15.2501 6C15.2501 7.79493 13.7951 9.25 12.0001 9.25C10.2052 9.25 8.75013 7.79493 8.75013 6Z" fill="currentColor" /><path fillRule="evenodd" clipRule="evenodd" d="M12.0001 12.25C9.68658 12.25 7.55506 12.7759 5.97558 13.6643C4.41962 14.5396 3.25013 15.8661 3.25013 17.5L3.25007 17.602C3.24894 18.7638 3.24752 20.222 4.52655 21.2635C5.15602 21.7761 6.03661 22.1406 7.22634 22.3815C8.4194 22.6229 9.97436 22.75 12.0001 22.75C14.0259 22.75 15.5809 22.6229 16.7739 22.3815C17.9637 22.1406 18.8443 21.7761 19.4737 21.2635C20.7527 20.222 20.7513 18.7638 20.7502 17.602L20.7501 17.5C20.7501 15.8661 19.5807 14.5396 18.0247 13.6643C16.4452 12.7759 14.3137 12.25 12.0001 12.25ZM4.75013 17.5C4.75013 16.6487 5.37151 15.7251 6.71098 14.9717C8.02693 14.2315 9.89541 13.75 12.0001 13.75C14.1049 13.75 15.9733 14.2315 17.2893 14.9717C18.6288 15.7251 19.2501 16.6487 19.2501 17.5C19.2501 18.8078 19.2098 19.544 18.5265 20.1004C18.156 20.4022 17.5366 20.6967 16.4763 20.9113C15.4194 21.1252 13.9744 21.25 12.0001 21.25C10.0259 21.25 8.58087 21.1252 7.52393 20.9113C6.46366 20.6967 5.84425 20.4022 5.47372 20.1004C4.79045 19.544 4.75013 18.8078 4.75013 17.5Z" fill="currentColor" /></svg>
                ...
                <li>
                  <div>
                    <button aria-expanded="false" className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white flex w-full items-center gap-3 py-3">
                  ...
                  <div>
                    ...
                    </button>
                    {
                      isOpenInsuranceCompany && (
                        <ul className="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium transition-all duration-200  hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2" to="/AhlieReport" >
                              <span>{t("sideBar.mainMenu.categore.report.categore.insuranceAhliaRep")}</span>
                            </Link>
                          </li>
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" to='/MashreqReport'>
                          ...
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" to="/TakafulRep">
                              <span>{t("sideBar.mainMenu.categore.report.categore.TakafulRep")}</span>
                            </Link>
                          </li>
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" to="/PalestineRep">
                              <span>{t("sideBar.mainMenu.categore.report.categore.PalestineRep")}</span>
                            </Link>
                          </li>
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" to="/TrustRep">
                              <span>{t("sideBar.mainMenu.categore.report.categore.TrustReport")}</span>
                            </Link>
                          </li>
                          <li role="none">
                            <Link className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" to='/HolyLand'>
          ...
          <div className="mb-4">
            ...
            <nav role="navigation" aria-label="MAIN MENU">
              <ul className="space-y-2">
                <li>
                  <a className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3" href="/message">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6 shrink-0 w-[19px] h-[19px]" >
                ...
                <li>
                  <a className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3" href="/inbox">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6 shrink-0 w-[19px] h-[19px]" >
                  ...
                  <div>
                    ...
                    </button>
                    {
                      isOpenSetting && (
                        <ul className="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                          <li role="none">
                            <a className="text-[14px] rounded-lg px-3.5 font-medium transition-all duration-200 bg-[rgba(87,80,241,0.07)] text-primary hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2" href="/login">
                              <span>{t("sideBar.settings.auth.categore.signIn")}</span>
                            </a>
                          </li>

                          <li role="none">
                            <a className="text-[14px] rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" href="/analytics">
